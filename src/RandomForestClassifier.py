...
#redemensionner les features 4D en 2D
nsamples, nx, ny, nz = X.shape
d2_X = X.reshape((nsamples,nx*ny*nz))

#apprentissage
#decoupper l'echantillon en partie train/test
X_train, X_test, y_train, y_test = train_test_split(d2_X, y, test_size=0.20, random_state=0)
...
classifieur = RandomForestClassifier(n_estimators=20, random_state=0)
...
print("le taux de réussite avec le classifieur foret aléatoire : ",accuracy_score(y_test,y_predits))
